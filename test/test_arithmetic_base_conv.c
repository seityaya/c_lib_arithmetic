    ...
    UT_GROUP_BEG(convert_sign) {
        UT_GROUP_BEG(positiv) {
            UT_GROUP_BEG(is_to_pos) {
                UT_ASSERT_BOOL_TR(is_to_pos(s8_c(-1)));
                UT_ASSERT_BOOL_TR(is_to_pos(s8_c(0)));
                UT_ASSERT_BOOL_TR(is_to_pos(s8_c(1)));

                UT_ASSERT_BOOL_TR(is_to_pos(s8_c(-127)));
                UT_ASSERT_BOOL_FL(is_to_pos(s8_c(-128)));
            ...
            UT_GROUP_BEG(to_pos) {
                UT_ASSERT_NUM_EQ(s8_c(1), to_pos(s8_c(-1)));
                UT_ASSERT_NUM_EQ(s8_c(0), to_pos(s8_c(0)));
                UT_ASSERT_NUM_EQ(s8_c(1), to_pos(s8_c(1)));

                UT_ASSERT_NUM_EQ(s8_c(127), to_pos(s8_c(-127)));
                UT_ASSERT_NUM_EQ(s8_c(-128), to_pos(s8_c(-128)));
            ...
            UT_GROUP_BEG(to_pos_chk) {
                ss8_t res_i = 0;
                f32_t res_f = 0;
                UT_ASSERT_BOOL_TR(to_pos_chk(res_i, s8_c(-1)));
                UT_ASSERT_NUM_EQ(res_i, s8_c(1));

                UT_ASSERT_BOOL_TR(to_pos_chk(res_i, s8_c(0)));
                ...
                res_i = 33;
                UT_ASSERT_BOOL_TR(to_pos_chk(res_i, s8_c(-127)));
                UT_ASSERT_NUM_EQ(res_i, s8_c(127));

                res_i = 33;
                UT_ASSERT_BOOL_FL(to_pos_chk(res_i, s8_c(-128)));
        ...
        UT_GROUP_BEG(negativ) {
            UT_GROUP_BEG(is_to_neg) {
                UT_ASSERT_BOOL_TR(is_to_neg(s8_c(-1)));
                UT_ASSERT_BOOL_TR(is_to_neg(s8_c(0)));
                UT_ASSERT_BOOL_TR(is_to_neg(s8_c(1)));

                UT_ASSERT_BOOL_TR(is_to_neg(s8_c(-127)));
                UT_ASSERT_BOOL_TR(is_to_neg(s8_c(-128)));
            ...
            UT_GROUP_BEG(to_neg) {
                UT_ASSERT_NUM_EQ(s8_c(-1), to_neg(s8_c(-1)));
                UT_ASSERT_NUM_EQ(s8_c(0), to_neg(s8_c(0)));
                UT_ASSERT_NUM_EQ(s8_c(-1), to_neg(s8_c(1)));

                UT_ASSERT_NUM_EQ(s8_c(-127), to_neg(s8_c(-127)));
                UT_ASSERT_NUM_EQ(s8_c(-128), to_neg(s8_c(-128)));
            ...
            UT_GROUP_BEG(to_neg_chk) {
                ss8_t res_i = 0;
                f32_t res_f = 0;
                UT_ASSERT_BOOL_TR(to_neg_chk(res_i, s8_c(-1)));
                UT_ASSERT_NUM_EQ(res_i, s8_c(-1));

                UT_ASSERT_BOOL_TR(to_neg_chk(res_i, s8_c(0)));
                UT_ASSERT_NUM_EQ(res_i, s8_c(0));
                ...
                res_i = 33;
                UT_ASSERT_BOOL_TR(to_neg_chk(res_i, s8_c(-127)));
                UT_ASSERT_NUM_EQ(res_i, s8_c(-127));

                res_i = 33;
                UT_ASSERT_BOOL_TR(to_neg_chk(res_i, s8_c(-128)));
                UT_ASSERT_NUM_EQ(res_i, s8_c(-128));
